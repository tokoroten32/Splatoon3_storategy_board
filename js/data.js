...
const WEAPON_DATA = {
  'shooter': {
    ...
    weapons: [
      ...
      { key: 'prime_shooter', name: 'プライムシューター', src: './icons/weapon-main/shooter/プライムシューター.png', width: 30, height: 30 }, // .png.webp -> .png
  ...
  'slosher': {
    ...
    weapons: [
      ...
      { key: 'explosher', name: 'エクスプロッシャー', src: './icons/weapon-main/slosher/エクスプロッシャー.png', width: 30, height: 30 },
  ...
  'spinner': {
    ...
    weapons: [
      ...
      { key: 'hydrant', name: 'ハイドラント', src: './icons/weapon-main/spinner/ハイドラント.png', width: 30, height: 30 },
      ...
      { key: 'nautilus_47', name: 'ノーチラス47', src: './icons/weapon-main/spinner/ノーチラス47.png', width: 30, height: 30 },
      { key: 'nautilus_79', name: 'ノーチラス79', src: './icons/weapon-main/spinner/ノーチラス79.png.webp', width: 30, height: 30 },
      { key: 'examiner', name: 'イグザミナー', src: './icons/weapon-main/spinner/イグザミナー.png', width: 30, height: 30 },
  ...
  'burster': {
    ...
    weapons: [
      ...
      { key: 'long_blaster', name: 'ロングブラスター', src: './icons/weapon-main/burster/ロングブラスター.png', width: 30, height: 30 },
      { key: 'long_blaster_custom', name: 'ロングブラスターカスタム', src: './icons/weapon-main/burster/ロングブラスターカスタム.png.webp', width: 30, height: 30 },
      { key: 'clash_blaster', name: 'クラッシュブラスター', src: './icons/weapon-main/burster/クラッシュブラスター.png', width: 30, height: 30 },
      { key: 'clash_blaster_neo', name: 'クラッシュブラスターネオ', src: './icons/weapon-main/burster/クラッシュブラスターネオ.png.webp', width: 30, height: 30 },
      { key: 'rapid_blaster', name: 'ラピッドブラスター', src: './icons/weapon-main/burster/ラピッドブラスター.png', width: 30, height: 30 },
