...
const WEAPON_DATA = {
  'shooter': {
    ...
    weapons: [
      ...
      { key: 'prime_shooter_collabo', name: 'プライムシューターコラボ', src: './icons/weapon-main/shooter/プライムシューターコラボ.png.webp', width: 30, height: 30 },
      ...
      { key: 'space_shooter', name: 'スペースシューター', src: './icons/weapon-main/shooter/スペースシューター.png.webp', width: 30, height: 30 },
      { key: 'space_shooter_collabo', name: 'スペースシューターコラボ', src: './icons/weapon-main/shooter/スペースシューターコラボ.png.webp', width: 30, height: 30 },
      ...
      { key: 'bottlegeist_foil', name: 'ボトルガイザーフォイル', src: './icons/weapon-main/shooter/ボトルガイザーフォイル.png.webp', width: 30, height: 30 },
    ]
  },
  'roller': {
    displayName: 'ローラー',
    weapons: [
      ...
      { key: 'carbon_roller_deco', name: 'カーボンローラーデコ', src: './icons/weapon-main/roller/カーボンローラーデコ.png.webp', width: 30, height: 30 },
  ...
  'charger': {
    ...
    weapons: [
      ...
      { key: 'splat_charger_collabo', name: 'スプラチャージャーコラボ', src: './icons/weapon-main/charger/スプラチャージャーコラボ.png.webp', width: 30, height: 30 },
      { key: 'splat_scope', name: 'スプラスコープ', src: './icons/weapon-main/charger/スプラスコープ.png', width: 30, height: 30 },
      { key: 'splat_scope_collabo', name: 'スプラスコープコラボ', src: './icons/weapon-main/charger/スプラスコープコラボ.png.webp', width: 30, height: 30 },
      { key: 'liter_4k', name: 'リッター4K', src: './icons/weapon-main/charger/リッター4K.png', width: 30, height: 30 },
      { key: 'liter_4k_custom', name: 'リッター4Kカスタム', src: './icons/weapon-main/charger/リッター4Kカスタム.png.webp', width: 30, height: 30 },
      ...
      { key: 'squicklin_b', name: 'スクイックリンβ', src: './icons/weapon-main/charger/スクイックリンβ.png.webp', width: 30, height: 30 },
      { key: 'bamboozler_14_mk1', name: '14式竹筒銃・甲', src: './icons/weapon-main/charger/14式竹筒銃・甲.png', width: 30, height: 30 },
      { key: 'bamboozler_14_mk2', name: '14式竹筒銃・乙', src: './icons/weapon-main/charger/14式竹筒銃・乙.png.webp', width: 30, height: 30 },
      { key: 'soytuber', name: 'ソイチューバー', src: './icons/weapon-main/charger/ソイチューバー.png', width: 30, height: 30 },
      { key: 'soytuber_custom', name: 'ソイチューバーカスタム', src: './icons/weapon-main/charger/ソイチューバーカスタム.png.webp', width: 30, height: 30 },
      { key: 'rpen_5b', name: 'R-PEN／5B', src: './icons/weapon-main/charger/R-PEN／5B.png', width: 30, height: 30 },
      { key: 'rpen_5h', name: 'R-PEN／5H', src: './icons/weapon-main/charger/R-PEN／5H.png.webp', width: 30, height: 30 },
    ]
  },
  'slosher': {
    displayName: 'スロッシャー',
    weapons: [
      ...
      { key: 'bucket_slosher_deco', name: 'バケットスロッシャーデコ', src: './icons/weapon-main/slosher/バケットスロッシャーデコ.png.webp', width: 30, height: 30 },
      { key: 'hissen', name: 'ヒッセン', src: './icons/weapon-main/slosher/ヒッセン.png', width: 30, height: 30 },
      { key: 'hissen_hue', name: 'ヒッセンヒュー', src: './icons/weapon-main/slosher/ヒッセン・ヒュー.png', width: 30, height: 30 }, // WEAPON_SUB_SPECIAL_DATA に合わせる
      { key: 'screw_slosher', name: 'スクリュースロッシャー', src: './icons/weapon-main/slosher/スクリュースロッシャー.png', width: 30, height: 30 },
      { key: 'screw_slosher_neo', name: 'スクリュースロッシャーネオ', src: './icons/weapon-main/slosher/スクリュースロッシャーネオ.png.webp', width: 30, height: 30 },
      { key: 'explosher', name: 'エクスプロッシャー', src: './icons/weapon-main/slosher/エクスプロッシャー.png.webp', width: 30, height: 30 },
      ...
      { key: 'overflosher_deco', name: 'オーバーフロッシャーデコ', src: './icons/weapon-main/slosher/オーバーフロッシャーデコ.png.webp', width: 30, height: 30 },
  ...
  'spinner': {
    ...
    weapons: [
      ...
      { key: 'splat_spinner_collabo', name: 'スプラスピナーコラボ', src: './icons/weapon-main/spinner/スプラスピナーコラボ.png.webp', width: 30, height: 30 },
      { key: 'barrel_spinner', name: 'バレルスピナー', src: './icons/weapon-main/spinner/バレルスピナー.png', width: 30, height: 30 },
      { key: 'barrel_spinner_deco', name: 'バレルスピナーデコ', src: './icons/weapon-main/spinner/バレルスピナーデコ.png.webp', width: 30, height: 30 },
      { key: 'hydrant', name: 'ハイドラント', src: './icons/weapon-main/spinner/ハイドラント.png.webp', width: 30, height: 30 },
      ...
      { key: 'kugelschreiber_hue', name: 'クーゲルシュライバーヒュー', src: './icons/weapon-main/spinner/クーゲルシュライバー・ヒュー.png', width: 30, height: 30 }, // WEAPON_SUB_SPECIAL_DATA に合わせる
      { key: 'nautilus_47', name: 'ノーチラス47', src: './icons/weapon-main/spinner/ノーチラス47.png.webp', width: 30, height: 30 },
      { key: 'nautilus_79', name: 'ノーチラス79', src: './icons/weapon-main/spinner/ノーチラス79.png.webp', width: 30, height: 30 },
      { key: 'examiner', name: 'イグザミナー', src: './icons/weapon-main/spinner/イグザミナー.png.webp', width: 30, height: 30 },
  ...
  'burster': {
    displayName: 'ブラスター',
    weapons: [
      { key: 'nova_blaster', name: 'ノヴァブラスター', src: './icons/weapon-main/burster/ノヴァブラスター.png.webp', width: 30, height: 30 },
      { key: 'nova_blaster_neo', name: 'ノヴァブラスターネオ', src: './icons/weapon-main/burster/ノヴァブラスターネオ.png.webp', width: 30, height: 30 },
      { key: 'hot_blaster', name: 'ホットブラスター', src: './icons/weapon-main/burster/ホットブラスター.png', width: 30, height: 30 },
      { key: 'hot_blaster_custom', name: 'ホットブラスターカスタム', src: './icons/weapon-main/burster/ホットブラスターカスタム.png.webp', width: 30, height: 30 },
      { key: 'long_blaster', name: 'ロングブラスター', src: './icons/weapon-main/burster/ロングブラスター.png.webp', width: 30, height: 30 },
      { key: 'long_blaster_custom', name: 'ロングブラスターカスタム', src: './icons/weapon-main/burster/ロングブラスターカスタム.png.webp', width: 30, height: 30 },
      { key: 'clash_blaster', name: 'クラッシュブラスター', src: './icons/weapon-main/burster/クラッシュブラスター.png.webp', width: 30, height: 30 },
      { key: 'clash_blaster_neo', name: 'クラッシュブラスターネオ', src: './icons/weapon-main/burster/クラッシュブラスターネオ.png.webp', width: 30, height: 30 },
      { key: 'rapid_blaster', name: 'ラピッドブラスター', src: './icons/weapon-main/burster/ラピッドブラスター.png.webp', width: 30, height: 30 },
  ...
  'brella': {
    ...
    weapons: [
      ...
      { key: 'parashelter_sorella', name: 'パラシェルターソレーラ', src: './icons/weapon-main/brella/パラシェルターソレーラ.png.webp', width: 30, height: 30 },
      { key: 'camping_shelter', name: 'キャンピングシェルター', src: './icons/weapon-main/brella/キャンピングシェルター.png', width: 30, height: 30 },
      { key: 'camping_shelter_sorella', name: 'キャンピングシェルターソレーラ', src: './icons/weapon-main/brella/キャンピングシェルターソレーラ.png.webp', width: 30, height: 30 },
      { key: 'spy_gadget', name: 'スパイガジェット', src: './icons/weapon-main/brella/スパイガジェット.png.webp', width: 30, height: 30 },
  ...
  'brush': {
    ...
    weapons: [
      ...
      { key: 'pablo_hue', name: 'パブロヒュー', src: './icons/weapon-main/brush/パブロ・ヒュー.png', width: 30, height: 30 }, // WEAPON_SUB_SPECIAL_DATA に合わせる
      { key: 'hokusai', name: 'ホクサイ', src: './icons/weapon-main/brush/ホクサイ.png', width: 30, height: 30 },
      { key: 'hokusai_hue', name: 'ホクサイヒュー', src: './icons/weapon-main/brush/ホクサイ・ヒュー.png', width: 30, height: 30 }, // WEAPON_SUB_SPECIAL_DATA に合わせる
      { key: 'fincent', name: 'フィンセント', src: './icons/weapon-main/brush/フィンセント.png', width: 30, height: 30 },
      { key: 'fincent_hue', name: 'フィンセントヒュー', src: './icons/weapon-main/brush/フィンセント・ヒュー.png', width: 30, height: 30 }, // WEAPON_SUB_SPECIAL_DATA に合わせる
    ]
  },
  'dualies': {
    displayName: 'マニューバー',
    weapons: [
      ...
      { key: 'dual_sweeper', name: 'デュアルスイーパー', src: './icons/weapon-main/dualies/デュアルスイーパー.png.webp', width: 30, height: 30 },
      { key: 'dual_sweeper_custom', name: 'デュアルスイーパーカスタム', src: './icons/weapon-main/dualies/デュアルスイーパーカスタム.png.webp', width: 30, height: 30 },
      { key: 'quad_hopper_black', name: 'クアッドホッパーブラック', src: './icons/weapon-main/dualies/クアッドホッパーブラック.png', width: 30, height: 30 },
      { key: 'quad_hopper_white', name: 'クアッドホッパーホワイト', src: './icons/weapon-main/dualies/クアッドホッパーホワイト.png.webp', width: 30, height: 30 },
      { key: 'splatter_hue', name: 'スパッタリーヒュー', src: './icons/weapon-main/dualies/スパッタリー・ヒュー.png', width: 30, height: 30 }, // WEAPON_SUB_SPECIAL_DATA に合わせる
  ...
  'stringer': {
    ...
    weapons: [
      ...
      { key: 'tristringer_collabo', name: 'トライストリンガーコラボ', src: './icons/weapon-main/stringer/トライストリンガーコラボ.png.webp', width: 30, height: 30 },
      { key: 'lact_450', name: 'LACT-450', src: './icons/weapon-main/stringer/LACT-450.png', width: 30, height: 30 },
      { key: 'lact_450_deco', name: 'LACT-450デコ', src: './icons/weapon-main/stringer/LACT-450デコ.png.webp', width: 30, height: 30 },
  ...
  'wiper': {
    ...
    weapons: [
      ...
      { key: 'drive_wiper_deco', name: 'ドライブワイパーデコ', src: './icons/weapon-main/wiper/ドライブワイパーデコ.png.webp', width: 30, height: 30 },
      { key: 'gym_wiper', name: 'ジムワイパー', src: './icons/weapon-main/wiper/ジムワイパー.png', width: 30, height: 30 },
      { key: 'gym_wiper_hue', name: 'ジムワイパーヒュー', src: './icons/weapon-main/wiper/ジムワイパー・ヒュー.png', width: 30, height: 30 }, // WEAPON_SUB_SPECIAL_DATA に合わせる
...
const SPECIAL_WEAPON_DATA = [
  ...
  { key: 'megaphone_laser', name: 'メガホンレーザー', src: './icons/special/メガホンレーザー5.1ch.webp', width: 30, height: 30 } // WEAPON_SUB_SPECIAL_DATA に合わせる
];
...
const WEAPON_SUB_SPECIAL_DATA = [
  ...
  {"weapon":"もみじシューター","sub":"トーピード","special":"ホップソナー"},
  {"weapon":"プロモデラーMG","sub":"タンサンボム","special":"サメライド"},
  {"weapon":"プロモデラーRG","sub":"スプリンクラー","special":"ナイスダマ"},
  {"weapon":"スペースシューター","sub":"ポイントセンサー","special":"メガホンレーザー"},
  {"weapon":"スペースシューターコラボ","sub":"トラップ","special":"ジェットパック"},
  ...
  {"weapon":"プライムシューターコラボ","sub":"キューバンボム","special":"ナイスダマ"},
  {"weapon":".96ガロン","sub":"スプリンクラー","special":"キューインキ"},
  {"weapon":".96ガロンデコ","sub":"スプラッシュシールド","special":"テイオウイカ"},
  {"weapon":"H3リールガン","sub":"ポイントセンサー","special":"エナジースタンド"},
  {"weapon":"H3リールガンD","sub":"スプラッシュシールド","special":"グレートバリア"},
  ...
  {"weapon":"ボールドマーカーネオ","sub":"ジャンプビーコン","special":"メガホンレーザー"},
  {"weapon":"ボトルガイザー","sub":"スプラッシュシールド","special":"ウルトラショット"},
  {"weapon":"ボトルガイザーフォイル","sub":"ロボットボム","special":"スミナガシート"},
  // ローラー
  {"weapon":"スプラローラー","sub":"カーリングボム","special":"グレートバリア"},
  {"weapon":"スプラローラーコラボ","sub":"ジャンプビーコン","special":"テイオウイカ"},
  {"weapon":"カーボンローラー","sub":"ロボットボム","special":"ショクワンダー"},
  {"weapon":"カーボンローラーデコ","sub":"クイックボム","special":"ウルトラショット"},
  {"weapon":"ダイナモローラー","sub":"スプリンクラー","special":"エナジースタンド"},
  {"weapon":"ダイナモローラーテスラ","sub":"スプラッシュボム","special":"デコイチラシ"},
  ...
  {"weapon":"スプラスコープ","sub":"スプラッシュボム","special":"キューインキ"},
  {"weapon":"スプラスコープコラボ","sub":"スプラッシュシールド","special":"トリプルトルネード"},
  {"weapon":"スクイックリンα","sub":"ポイントセンサー","special":"グレートバリア"},
  {"weapon":"スクイックリンβ","sub":"ロボットボム","special":"ショクワンダー"},
  {"weapon":"リッター4K","sub":"トラップ","special":"ホップソナー"},
  {"weapon":"リッター4Kカスタム","sub":"ジャンプビーコン","special":"テイオウイカ"},
  {"weapon":"4Kスコープ","sub":"トラップ","special":"ホップソナー"},
  {"weapon":"4Kスコープカスタム","sub":"ジャンプビーコン","special":"テイオウイカ"},
  ...
  {"weapon":"ヒッセン","sub":"ポイズンミスト","special":"ジェットパック"},
  {"weapon":"ヒッセンヒュー","sub":"タンサンボム","special":"エナジースタンド"},
  {"weapon":"スクリュースロッシャー","sub":"タンサンボム","special":"ナイスダマ"},
  {"weapon":"スクリュースロッシャーネオ","sub":"ポイントセンサー","special":"ウルトラショット"},
  {"weapon":"オーバーフロッシャー","sub":"スプリンクラー","special":"アメフラシ"},
  {"weapon":"オーバーフロッシャーデコ","sub":"ラインマーカー","special":"テイオウイカ"},
  ...
  {"weapon":"ハイドラント","sub":"ロボットボム","special":"ナイスダマ"},
  {"weapon":"ハイドラントカスタム","sub":"トラップ","special":"スミナガシート"},
  {"weapon":"スプラスピナー","sub":"クイックボム","special":"ウルトラハンコ"},
  {"weapon":"スプラスピナーコラボ","sub":"ポイズンミスト","special":"グレートバリア"},
  {"weapon":"ノーチラス47","sub":"ポイントセンサー","special":"アメフラシ"},
  {"weapon":"ノーチラス79","sub":"キューバンボム","special":"ウルトラチャクチ"},
  ...
  {"weapon":"Rブラスターエリートデコ","sub":"ラインマーカー","special":"メガホンレーザー"},
  {"weapon":"ノヴァブラスター","sub":"スプラッシュボム","special":"ショクワンダー"},
  {"weapon":"ノヴァブラスターネオ","sub":"タンサンボム","special":"ウルトラハンコ"},
  ...
  {"weapon":"クアッドホッパーブラック","sub":"ロボットボム","special":"サメライド"},
  {"weapon":"クアッドホッパーホワイト","sub":"スプリンクラー","special":"ショクワンダー"},
  {"weapon":"ケルビン525","sub":"スプラッシュシールド","special":"ナイスダマ"},
  {"weapon":"ケルビン525デコ","sub":"ポイントセンサー","special":"ウルトラショット"},
  {"weapon":"スパッタリー","sub":"ジャンプビーコン","special":"エナジースタンド"},
  {"weapon":"スパッタリーヒュー","sub":"トーピード","special":"サメライド"},
  ...
  {"weapon":"キャンピングシェルター","sub":"ジャンプビーコン","special":"キューインキ"},
  {"weapon":"キャンピングシェルターソレーラ","sub":"トラップ","special":"ウルトラショット"},
  ...
  {"weapon":"ホクサイ","sub":"キューバンボム","special":"ショクワンダー"},
  {"weapon":"ホクサイヒュー","sub":"ジャンプビーコン","special":"アメフラシ"},
  {"weapon":"フィンセント","sub":"カーリングボム","special":"ホップソナー"},
  {"weapon":"フィンセントヒュー","sub":"ポイントセンサー","special":"マルチミサイル"},
  // ストリンガー
  ...
  {"weapon":"ジムワイパー","sub":"クイックボム","special":"ショクワンダー"},
  {"weapon":"ジムワイパーヒュー","sub":"ポイズンミスト","special":"カニタンク"},
  {"weapon":"デンタルワイパーミント","sub":"キューバンボム","special":"グレートバリア"},
  {"weapon":"デンタルワイパースミ","sub":"スプラッシュシールド","special":"ジェットパック"}
];
